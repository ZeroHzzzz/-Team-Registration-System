        ...
        <el-menu default-active="2" class="el-menu" :collapse="isCollapse" @open="handleOpen" @close="handleClose">
            ...
            <el-menu-item-group>
                ...
                <el-menu-item index="1-3" @click="pushToTeam"><el-icon>
                    ...
                    <span v-if="hasCollapse">团队展示</span>
                </el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
                <template #title><span>个人</span></template>
                <el-menu-item index="1-4" @click="pushToPerson"><el-icon>
                        <UserFilled />
                    </el-icon>
...
const isDisabled = ref(newUserStore.userSession.Type !== 3);
...
onMounted(async () => {
    const Email = newUserStore.userSession.Email;
    console.log(Email);
    const res = await message.get(Email);
