...
<template>
    <div>
        <el-card class="multi-table">
            ...
            <el-table class="team-table" :data="TableData1.slice( (currentPage - 1 ) * pageSize, currentPage * pageSize)" height="480" style="width: 100%" border>
